namespace Swarmbreaker.Cs_Files
{
	public static class SaveData
	{
		...
		public static void addEnemy(int y, int x, float speed, float statBaseHP, float statBaseAttack, float statBonusAttack, float statBonusArmor, int xpDrop, int id, Boolean isBoss)
		{
